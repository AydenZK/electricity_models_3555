...
```{r}
elec_austria <- data %>% filter(Country=="Austria") %>% select(Date, TotalLoadValue) %>% as_tsibble()
```
...
```{r}
elec_belgium <- data %>% filter(Country=="Belgium") %>% 
  select(Date, TotalLoadValue) %>% as_tibble()

elec_spain <- data %>% filter(Country=="Spain") %>% 
  select(Date, TotalLoadValue) %>% as_tibble()

elec_croatia <- data %>% filter(Country=="Croatia") %>% 
  select(Date, TotalLoadValue) %>% as_tibble()

elec_italy <- data %>% filter(Country=="Italy") %>% 
  select(Date, TotalLoadValue) %>% as_tibble()
```
